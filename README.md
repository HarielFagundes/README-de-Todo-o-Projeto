...
o projeto em si é um site que contem um sistema de pesquisa onde o ADM cria perguntas para o cliente responder para uma pesquisa .


foram utilizadas para o projeto  JS,CSS,Postgres,Node,JSON,Front,Back.
